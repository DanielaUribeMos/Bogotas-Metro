...
#Costos 1ra mayo
costo_mayo= 1800*rowSums((Re(steadyStates(cmtcMayo)))*estados1)+1053685.49

#Costos NQS
costo_NQS= 1800*rowSums((Re(steadyStates(cmtcNQS)))*estados2)+1053685.49

#Costos Caracas
costo_caracas= 1800*rowSums((Re(steadyStates(cmtcCaracas)))*estados3)+1053685.49
